  ...
  <body>
    <nav class="navbar navbar-expand navbar-light sticky-top bg-light p-0 shadow" aria-label="Second navbar example">
      <div class="container-fluid">
        <a class="navbar-brand" href="{{ url('/')}}"><img src="img/logo-pt.png" alt=""></a>
...
{{-- <header class="navbar navbar-light sticky-top bg-light flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 px-3" href="#"><img src="{{('img/logo-pt.png')}}" width="36" height="28" alt="">MyDrink</a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active d-flex justify-content-start align-items-center" aria-current="page" href="#">
